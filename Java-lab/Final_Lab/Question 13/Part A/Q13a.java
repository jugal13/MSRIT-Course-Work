...
public class Q13a {
	...
	public static void main(String[] args) {
        ...
        boolean ch=true;
        while(ch) {
            System.out.println("Select an option 1.Reserve Train 2.Reserve  Bus 3. Exit");
            op=sc.nextInt();
            switch(op) {
            	case 1:
            		System.out.println("number of seats availabe" +ReserveTrain.nost);
            		...
            		break;
            	case 2:
            		System.out.println("number of seats availabe" +ReserveBus.nosb);
            		System.out.println("enter type of seat (ac/sleeper/general)");
            		tos=sc.next();
            		System.out.println("enter number of seats to reserve ");
            		seat=sc.nextInt();
